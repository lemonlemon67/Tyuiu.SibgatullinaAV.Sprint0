...
using Tyuiu.SibgatullinaAV.Sprint0.Task7.V0.Lib;

namespace Tyuiu.SibgatullinaAV.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Сибгатуллина А.В. | РППб-26-1";
            Console.WriteLine("***************************************************************************");
